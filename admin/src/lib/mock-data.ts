  ...
  pendingHospitals: [
    {
      ...
      documents: ["Registration Certificate", "License"],
    },
    {
      id: "VH002",
  ...
  pendingCandidates: [
    {
      ...
      documents: ["Medical Degree", "License", "ID Proof"],
    },
    {
      id: "VC002",
      name: "Ravi Shankar",
      ...
      documents: ["Nursing Diploma", "ID Proof"],
    },
    {
      id: "VC003",
      name: "Dr. Arjun Menon",
      ...
      documents: ["MBBS Certificate", "PG Degree"],
    },
  ],
};
...
export const systemLogs = [
  {
    id: "L001",
    action: "Recruiter created job",
    user: "Apollo Hospitals",
    timestamp: "2024-08-28 14:32:00",
  ...
  {
    id: "L003",
    action: "Admin verified hospital",
    user: "Super Admin",
    timestamp: "2024-08-28 12:10:00",
    status: "Success" as const,
  },
  {
    id: "L004",
    action: "Candidate registration failed",
    user: "System",
  ...
  {
    id: "L005",
    action: "Job posting flagged",
    user: "System",
    timestamp: "2024-08-28 10:20:00",
...
export const activityFeed = [
  {
    id: 1,
    text: "New hospital registered: City Care Hospital, Pune",
    time: "2 mins ago",
    type: "registration" as const,
  },
  {
    id: 2,
    text: "Dr. Priya Sharma applied to Senior Cardiologist at Apollo",
    time: "15 mins ago",
    type: "application" as const,
  },
  {
    id: 3,
    text: "New job posted: ICU Nurse at Fortis Healthcare",
    time: "32 mins ago",
    type: "job" as const,
  },
  {
    id: 4,
    text: "Manipal Hospital account suspended by admin",
    time: "1 hour ago",
    type: "alert" as const,
  },
  {
    id: 5,
    text: "Verification approved: Dr. Rajesh Kumar",
    time: "2 hours ago",
    type: "verification" as const,
  },
  {
    id: 6,
    text: "Candidate Sunita Reddy uploaded new credentials",
    time: "3 hours ago",
    type: "registration" as const,
  },
];
...
export const notifications = [
  {
    ...
    message: "City Care Hospital, Pune has registered and needs verification.",
    time: "2 mins ago",
    read: false,
  },
  {
    ...
    message: "Dr. Sneha Gupta submitted credentials for verification.",
    time: "15 mins ago",
    read: false,
  },
  {
  ...
  },
  {
    ...
    message: "Job posting by Kokilaben Hospital flagged for review.",
    time: "3 hours ago",
    read: false,
  },
  {
    id: 5,
    title: "New Candidate Batch",
    message: "12 new candidates registered in the last 24 hours.",
    time: "5 hours ago",
    read: true,
  },
];
